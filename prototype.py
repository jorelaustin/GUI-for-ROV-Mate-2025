...
from libraries.float.floatdialog import FLOAT_DIALOG
...
class MyApp(QMainWindow):
    ...
    def controlPanelTab(self):
        ...
        self.control_float_connect = self.ui.findChild(QPushButton, "control_float_connect")
        ...
        self.control_float_connect.clicked.connect(self.float.show)
